 ...
 * Tradução parcial e adaptação para versão =>6.x realizada por Andre Luiz Bellafronte <andre@bellafronte.net>
 *
 * @package    WHMCS
...
$_LANG['completeorder'] = "Finaliar Pedido";
...
$_LANG['knowledgebaseArticleRatingThanks'] = "Agradecemos seu feedback.";
...
$_LANG['orderPromoCodePlaceholder'] = "Insira aqui o código promocional caso possua um.";
...
$_LANG['supportticketsheader'] = "Se você não conseguir encontrar a solução para seu problema em nossa Base de Conhecimento, envie um Chamado de Suporte para o departamento selecionado abaixo.";
...
$_LANG['supportticketclosedmsg'] = "Este Chamado foi encerrado.  Você pode responder que ele será reaberto.";
...
$_LANG['domainaddonscancelfailed'] = "Falha ao desativer addon. Por favor entre em contato com o suporte.";

# Version 5.2

$_LANG['yourclientareahostingaddons'] = "Você possui os seguintes adicionais neste produto.";
$_LANG['loginrequired'] = "Você precisa estar logado";
$_LANG['unsubscribe'] = "Unsubscribe";
$_LANG['emailoptout'] = "Newsletter Opt-out";
$_LANG['newsletterunsubscribe'] = "Newsletter Unsubscribe";
$_LANG['emailoptoutdesc'] = "Marque para não desativar o recebimento de informativos";
$_LANG['alreadyunsubscribed'] = "Você já optou por não receber nossos informativos.";
...
$_LANG['unsubscribehashinvalid'] = "A desativação falhou, por favor informe este problema a equipe de suporte.";
$_LANG['unsubscribesuccess'] = "Desativado com sucesso";
$_LANG['newsletterremoved'] = "Obrigado, seu email foi removido com sucesso de nosso sistema de informativos.";
$_LANG['erroroccured'] = "Ocorreu um erro";
$_LANG['pwresetsuccessdesc'] = "Sua senha foi alterada. %sClique aqui%s para continuar...";
$_LANG['pwresetenternewpw'] = "Por favor digite a nova senha desejada abaixo.";
$_LANG['ordererrorsbudomainbanned'] = "O prefixo de subdomínio escolhido não é permitido - por favor escolha outro";

$_LANG['ticketfeedbacktitle'] = "Feedback do Chamado Solicitado";

$_LANG['nosupportdepartments'] = "No support departments found. Please try again later.";

$_LANG['feedbackclosed'] = "Feedback não pode ser fornecido até que o chamado esteja encerrado";
$_LANG['feedbackprovided'] = "Você já forneceu feedback para este chamado";
$_LANG['feedbackthankyou'] = "Nós agradecemos o tempo concedido para prover este feedback.";
$_LANG['feedbackreceived'] = "Avaliação Registrada com Sucesso";
...
$_LANG['feedbackclickreview'] = "Clique Aqui para avaliar o Chamado";
$_LANG['feedbackopenedat'] = "Aberto em";
$_LANG['feedbacklastreplied'] = "Última resposta para";
$_LANG['feedbackstaffinvolved'] = "Equipe envolvida";
$_LANG['feedbacktotalduration'] = "Duração Total";
$_LANG['feedbackpleaserate1'] = "Por favor avalie como foi o Atendimento de";
$_LANG['feedbackpleasecomment1'] = "Por favor comente como foi";
$_LANG['feedbackhandled'] = "neste chamado";
$_LANG['feedbackworst'] = "Pior";
$_LANG['feedbackbest'] = "Melhor";
$_LANG['feedbackimprove'] = "Como poderemos tornar sua experiência melhor no futuro?";
$_LANG['pleaserate2'] = "handled this support request";
$_LANG['returnclient'] = "Retornar a Area do Cliente";

$_LANG['clientareanavsecurity'] = "Configurações de Segurança";
$_LANG['twofactorauth'] = "Autenticação de Dois Fatores";
$_LANG['twofaenable'] = "Habilitar autenticação de Dois Fatores";
$_LANG['twofadisable'] = "Disabilitar autenticação de Dois Fatores";
$_LANG['twofaenableclickhere'] = "Clique aqui para habilitar";
$_LANG['twofadisableclickhere'] = "Clique aqui para desabilitar";
$_LANG['twofaenforced'] = "O administrador do sistema solicitou que você deve habilite a autenticação de dois fatores antes de continuar. Esta página irá guiá-lo através do processo de ativação.";
$_LANG['twofasetup'] = "Processo de Configuração de autenticação de Dois Fatores";
$_LANG['twofasetupgetstarted'] = "Vamos começar";
$_LANG['twofaactivationintro'] = "Autenticação de dois fatores adiciona uma camada extra de proteção para o acesso a suas informações. Quando habilitado &amp; configurado, cada vez que você logar-se no Painel de Controle você será solicitado a digitar seu usuário e senha padrão, bem como um segundo fator, como um código de segurança único.";
$_LANG['twofaactivationmultichoice'] = "Para continuar, por favor escolher o seu método de autenticação de dois fatores desejado a baixo.";
$_LANG['twofadisableintro'] = "Para desativar a autenticação de dois fatores, por favor digite a sua senha no campo abaixo.";
$_LANG['twofaactivationerror'] = "Ocorreu um erro ao tentar ativar autenticação de dois fatores para a sua conta. Por favor tente novamente.";
$_LANG['twofamoduleerror'] = "Ocorreu um erro ao carregar o módulo. Por favor, tente novamente.";
$_LANG['twofaactivationcomplete'] = "Autenticação de Dois Fatores configurada com Sucesso!";
$_LANG['twofadisableconfirmation'] = "Autenticação de dois fatores foi desativado para sua conta.";
$_LANG['twofabackupcodeis'] = "Seu código de Backup é";
$_LANG['twofanewbackupcodeis'] = "Seu novo Código de Backup é";
$_LANG['twofabackupcodelogin'] = "Digite seu Código de Backup para logar-se";
$_LANG['twofabackupcodeexpl'] = "Anote isso no papel e mantenha seguro.<br />Este código será necessário caso você tenha perdido seu dispositivo de Autenticaçãoo Dois Fatores ou ele não esteja disponível para você.";
$_LANG['twofaconfirmpw'] = "Digite sua senha";
$_LANG['twofa2ndfactorreq'] = "Seu Código de Autenticação de Dois Fatores é necessário para prosseguir.";
$_LANG['twofa2ndfactorincorrect'] = "Código de Autenticação de Dois Fatores Incorreto. Tente novamente.";
$_LANG['twofabackupcodereset'] = "Login através de Código de Backup realizado. Códigos de Backup são validos apenas uma única vez. Ele será resetado.";
$_LANG['twofacantaccess2ndfactor'] = "Não esta com seu dispositivo de Dois Fatores?";
$_LANG['twofaloginusingbackupcode'] = "Login realizado com Código de Backup";
...
$_LANG['twoipverificationstep'] = "Etapa de Verificação";
...
$_LANG['domaincontactdetails']['Contact Name'] = "Nome de Contato";
...
$_LANG['domaincontactdetails']['Organisation Name'] = "Organização";
...
$_LANG['serverhostnameexample'] = "ex. servidor1(.dominio.com)";
...
$_LANG['maxmind_checkconfiguration'] = "Ocorreu um erro na verificação anti-fraude. Por favor entre em contato com o Suporte.";
$_LANG['maxmind_addressinvalid'] = "Seu endereço não foi reconhecido. Por favor tente novamente.";
$_LANG['maxmind_invalidip'] = "Endereço IP inválido ou local desconhecido. Por favor contate o suporte.";

$_LANG['ssounabletologin'] = "Impossível realizar auto-login. Por favor contate o suporte.";
$_LANG['ssofatalerror'] = "Ocorreu um erro fatal. Por favor contate o suporte.";
...
$_LANG['backtoservicedetails'] = "Retornar a Detalhes do Serviço";
$_LANG['invoicesintro'] = "Abaixo você pode visualizar todo o seu histórico de faturas conosco.";
...
$_LANG['registersecurityquestionblurb'] = "Configurando uma pergunta de segurança fornecerá segurança adicional, todas as alterações em sua conta requerirá a resposta dessa pergunta secreta.";
...
$_LANG['yourtickets'] = "Seus Chamados";
$_LANG['managecontacts'] = "Gerenciar Contatos";
$_LANG['billingdetails'] = "Detalhes de Cobranças";
$_LANG['homechooseproductservice'] = "Escolha um produto/serviço para gerenciar:";

$_LANG['invoicesdue'] = "Faturas";
$_LANG['invoicesduemsg'] = "Você possui %s faturas vencidas e não pagas de um total de %s";
$_LANG['noinvoicesduemsg'] = "Oba! Nenhuma fatura em aberto neste momento.";

$_LANG['expiringsoon'] = "Vencendo em breve";

$_LANG['notice'] = "Notice";
$_LANG['networkstatussubtitle'] = "Informações e Novidades";
...
$_LANG['servername'] = "Servidor";
$_LANG['visitwebsite'] = "Acessar Website";
...
$_LANG['tableentersearchterm'] = "Inisra o termo da busca...";
...
$_LANG['ticketfeedbackrequest'] = "Feedback Necessário";
$_LANG['ticketfeedbackforticket'] = "para o chamado #";

$_LANG['notifications'] = "Notificações";
$_LANG['notificationsnone'] = "Você não possui notificações no momento.";

$_LANG['creditcardnonestored'] = "Nenhum cartão no arquivo";

$_LANG['kbviewingarticlestagged'] = "Viewing articles tagged";

$_LANG['domainprivatenameservers'] = "Nameservers Privativos";

$_LANG['transferinadomain'] = "Transfira um domínio";

$_LANG['nodomainextensions'] = "There are no Domain Extensions currently configured for purchase";

$_LANG['homebegin'] = "Procure seu domínio aqui...";
$_LANG['howcanwehelp'] = "Como podemos ajudar hoje?";
$_LANG['exampledomain'] = "ex. seudominio.com.br";
$_LANG['buyadomain'] = "Registrar um Domínio";
$_LANG['orderhosting'] = "Hospedar um Website";
$_LANG['makepayment'] = "Realizar pagamento";
$_LANG['getsupport'] = "Solicitar Suporte";

$_LANG['news'] = "Novidades";
$_LANG['allthelatest'] = "All the latest from";
$_LANG['readmore'] = "Leia Mais";
$_LANG['noannouncements'] = "Nenhum anúncio para ser exibido";

$_LANG['kbsearchexplain'] = "tem uma dúvida? Comece sua busca aqui.";
$_LANG['readyforquestions'] = "Estamos apostos para solucionar suas dúvidas";

$_LANG['restrictedpage'] = "Desculpe, esta página é restrita.";
$_LANG['enteremail'] = "Digite seu Email";

$_LANG['passwordtips'] = "<strong>Dicas para uma boa senha</strong><br />Utilize caracteres maiúsculas e minúsculas.<br />Inclua pelo menos um símbolo (# $ ! % &amp; etc...)<br />Não use palavras comuns";

$_LANG['regdate'] = "Reg Date";
$_LANG['nextdue'] = "Next Due";

$_LANG['domaincheckertagline'] = "Encontre o domínio perfeito para você...";
$_LANG['findyourdomain'] = "Encontre seu novo nome de dominio";
$_LANG['searchtermrequired'] = "Você precisa digitar um domínio ou termo para podermos buscar";
$_LANG['unabletolookup'] = "Perdão, não consegui buscar os termos desejados";
$_LANG['invalidchars'] = "Por favor, remova espaços em branco ou caracteres especias/pontuação";
$_LANG['bulkoptions'] = "Opções em Massa";
$_LANG['checkingdomain'] = "Estou verificando se o domínio solicitado esta disponível...";
$_LANG['domainsgotocheckout'] = "Finalizar Pedido";
$_LANG['domainssearchresults'] = "Resultados da Busca";
$_LANG['domainssuggestions'] = "Sugestões";
$_LANG['domainsothersuggestions'] = "Eu acredito que você possa se interessar nestes nomes alternativos";
$_LANG['domainsmoresuggestions'] = "Hey! Quero mais idéais!";
...
$_LANG['tldpricing'] = "Preço do TLD";
$_LANG['alltldpricing'] = "Preço de Todos os TLDs";

$_LANG['quotesdesc'] = "Quotes we have generated for you";
$_LANG['quotesrejected'] = "Rejeitado";

$_LANG['ticketsyourhistory'] = "Seu histórico de Chamados";

$_LANG['clientareaemaildesc'] = "Seu histórico de emails trocados com a gente";
...
$_LANG['ticketinfo'] = "Informação do Chamado";
...
$_LANG['domainsExpiringInTheNext30Days'] = "Expirando em 30 Dias";
$_LANG['domainsExpiringInTheNext90Days'] = "Expirando em 90 Dias";
$_LANG['domainsExpiringInTheNext180Days'] = "Expirando em 180 Dias";
$_LANG['domainsExpiringInMoreThan180Days'] = "Expirando em 180+ Dias";
...
$_LANG['quotelineitems'] = "Itens do Orçamento";

$_LANG['quoteproposal'] = "Proposta";
$_LANG['quoteacceptagreetos'] = "Para aceitar a proposta, por favor concorde com os Termos de Serviços.";
$_LANG['quoteacceptcontractwarning'] = "Tenha em mente que ao aceitar uma proposta você estará assinando um contrato e o mesmo não poderá ser cancelado.";
...
$_LANG['clientAlerts']['invoicesUnpaid'] = "Você Possui :numberOfInvoices fatura(s) não paga(s). Pague agora e ganhe Paz de Espírito =)";
$_LANG['clientAlerts']['invoicesOverdue'] = "Você Possui :numberOfInvoices fatura(s) vencida(s) com um total de :balanceDue. Pague agora para evitar interrupção nos serviços.";
$_LANG['clientAlerts']['creditBalance'] = "Você possui um crédito de :creditBalance.";

// Client homepage panels
$_LANG['clientHomePanels']['unpaidInvoices'] = "Faturas em Aberto";
$_LANG['clientHomePanels']['unpaidInvoicesMsg'] = "Você Possui :numberOfInvoices fatura(s) não paga(s) com o total de :balanceDue. Pague agora e ganhe Paz de Espírito =)";
$_LANG['clientHomePanels']['overdueInvoices'] = "Faturas Vencidas";
$_LANG['clientHomePanels']['overdueInvoicesMsg'] = "Você Possui :numberOfInvoices fatura(s) vencida(s) com um total de :balanceDue. Pague agora para evitar interrupção nos serviços.";
...
$_LANG['clientHomePanels']['activeProductsServicesNone'] = "Parece que você ainda não possuí nenhum serviço contratado. <a href=\"cart.php\">Contrate um Serviço Agora</a>.";
$_LANG['clientHomePanels']['recentNews'] = "Notícias Recentes";
$_LANG['clientHomePanels']['affiliateProgram'] = "Programa de Afiliados";
$_LANG['clientHomePanels']['recentSupportTickets'] = "Chamados de Suporte Recentes";
$_LANG['clientHomePanels']['recentSupportTicketsNone'] = "Nenhum Chamado recente encontrado. Você precisa de ajuda? Por favor <a href=\"submitticket.php\">abra um chamado</a>.";
...
$_LANG['viewAll'] = "Ver Tudo";
$_LANG['moreDetails'] = "Maiores Detalhes";

$_LANG['clientHomeSearchKb'] = "Insira uma pergunta para buscarmos em nossa base de conhecimento...";
...
$_LANG['domainchecker']['suggestiontakenmsg'] = "Triste, mas o domínio selecionado esta indisponível. Isto pode ocorrer algumas vezes quando o domínio foi registrado muito recentemente. Vamos escolher outro dominio?";
...
$_LANG['domainchecker']['alreadyincartcheckoutnow'] = "Fechar Pedido";

$_LANG['genericerror']['title'] = "Oops, algo esta errado!";
...
$_LANG['cPanel']['purchaseActivate'] = "Compras & Atividade";

$_LANG['cPanel']['usageStats'] = "Estatísticas de Uso";
$_LANG['cPanel']['diskUsage'] = "Uso do Disco";
$_LANG['cPanel']['bandwidthUsage'] = "Uso da Banda";
$_LANG['cPanel']['usageStatsBwLimitNear'] = "Você está Próximo do seu limite de dados.";
$_LANG['cPanel']['usageStatsDiskLimitNear'] = "Você esta próximo do limite do seu disco.";
$_LANG['cPanel']['usageUpgradeNow'] = "Atualizar Agora";
$_LANG['cPanel']['usageLastUpdated'] = "Último Atualizado";

$_LANG['cPanel']['quickShortcuts'] = "Atalhos Rápidos";
$_LANG['cPanel']['emailAccounts'] = "Contas de Emails";
$_LANG['cPanel']['forwarders'] = "Encaminhadores";
$_LANG['cPanel']['autoresponders'] = "Respostas Automáticas";
...
$_LANG['cPanel']['cronJobs'] = "Agendamento de Tarefas";
$_LANG['cPanel']['mysqlDatabases'] = "Bancos de Dados MySQL";
$_LANG['cPanel']['phpMyAdmin'] = "phpMyAdmin";
$_LANG['cPanel']['awstats'] = "Estatísticas de Acesso";

$_LANG['cPanel']['createEmailAccount'] = "Crie um Email Rapidamente";
$_LANG['cPanel']['usernamePlaceholder'] = "SuaConta";
...
$_LANG['cPanel']['emailAccountCreateFailed'] = "A Criação da conta de Email Falhou: ";
...
$_LANG['cPanel']['statusSuspendedNotice'] = "Você não pode continuar a usar ou gerenciar este pacote até que seja reativado.";
...
$_LANG['unableToLoadShoppingCart'] = "Impossível acessar seu carrinho de compras. Por favor avise o suporte.";

$_LANG['showMenu'] = "Mostrar Menu";
$_LANG['hideMenu'] = "Retrair Menu";
...
$_LANG['orderForm']['alreadyRegistered'] = "Já possuí registro?";
$_LANG['orderForm']['createAccount'] = "Criar uma Conta";
$_LANG['orderForm']['enterPersonalDetails'] = "Por favor, informe seus dados pessoais e informações de faturamento abaixo.";
$_LANG['orderForm']['correctErrors'] = "Please correct the following errors before continuing";
$_LANG['orderForm']['existingCustomerLogin'] = "Já é cliente? Insira suas credenciais";
...
$_LANG['orderForm']['cvv'] = "Código de Segurança CVV";
$_LANG['orderForm']['additionalNotes'] = "Notas ou Informações Adicionais";
$_LANG['orderForm']['continueToClientArea'] = "Continuar para a Area do Cliente";
...
$_LANG['orderForm']['configureDesiredOptions'] = "Configure as opções desejadas e finalize seu pedido";
...
$_LANG['orderForm']['check'] = "Marcar";
$_LANG['orderForm']['transfer'] = "Transferir";
$_LANG['orderForm']['domainAddedToCart'] = "Este dominio´foi adicionado ao seu carrinho.";
$_LANG['orderForm']['registerLongerAndSave'] = "Registre por mais anos e economize!";
...
$_LANG['orderForm']['submitTicket'] = "Abrir um Chamado";
$_LANG['orderForm']['promotionAccepted'] = "Código Promocional Aceito! Os totais do seu pedido foram atualizados.";
...
$_LANG['orderForm']['updateTotals'] = "Valores Totais atualizados";
...
$_LANG['orderForm']['includedWithPlans'] = "Incluso em Todos os Planos";
$_LANG['orderForm']['whatIsIncluded'] = "O que esta incluso?";
$_LANG['orderForm']['errorNoProductGroup'] = "Não consegui carregar nenhum grupo de produtos.";
$_LANG['orderForm']['errorNoProducts'] = "Grupo de Produto não possuí nenhum produto visível";

$_LANG['cloudSlider']['feature01Title'] = "Uptime Máximo dos Servidores";
...
$_LANG['cPanel']['usageStatsBwOverLimit'] = "Você excedeu seu limite de tráfego de dados (banda).";
$_LANG['cPanel']['usageStatsDiskOverLimit'] = "Você excedeu o espaço máximo do seu disco.";
